...
pub fn ContactSection() -> impl IntoView {
    view! {
        <div class="w-full py-12 flex flex-col items-center justify-center bg-tertiary-background gap-6 text-secondary-text relative z-[0]">
            ...
            <h3 class="mx-4 md:mx-0 md:w-[60%] md:max-w-[60%] lg:w-[30%] lg:max-w-[30%] text-center font-normal">"I'm open to conversations about interesting problems, systems, and opportunities for collaboration."</h3>

            <AnimatedLinkButton link="mailto:casey.vaughn9@gmail.com" title="Get in touch" class="mr-auto"/>
        </div>
    }
}
