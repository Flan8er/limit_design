...
pub fn PythonIcon() -> impl IntoView {
    view! {
        <svg width="100%" height="100%" viewBox="0 0 256 255" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid">
            <defs>
...
#[component]
pub fn LeptosIcon() -> impl IntoView {
    view! {
        <svg
            xmlns="http://www.w3.org/2000/svg"
            xml:space="preserve"
...
#[component]
pub fn BlenderIcon() -> impl IntoView {
    view! {
        <svg
            xmlns="http://www.w3.org/2000/svg"
            xml:space="preserve"
            ...
            viewBox="0 0 65 65"
        >
            <path xmlns="http://www.w3.org/2000/svg" d="M36.13 31.285c.106-1.891 1.032-3.557 2.429-4.738 1.37-1.16 3.214-1.869 5.226-1.869 2.01 0 3.854.709 5.225 1.869 1.396 1.181 2.322 2.847 2.429 4.736.106 1.943-.675 3.748-2.045 5.086-1.397 1.361-3.384 2.215-5.609 2.215s-4.216-.854-5.612-2.215c-1.371-1.338-2.15-3.143-2.043-5.084" style="fill:#0e548b;fill-rule:nonzero"/>
            <path xmlns="http://www.w3.org/2000/svg" d="M23.94 35.106c.013.74.249 2.178.603 3.301.744 2.377 2.006 4.576 3.762 6.514 1.802 1.992 4.021 3.592 6.584 4.728 2.694 1.193 5.613 1.801 8.645 1.796a21.2 21.2 0 0 0 8.64-1.826c2.563-1.147 4.78-2.754 6.579-4.747 1.755-1.946 3.015-4.149 3.761-6.526.375-1.201.612-2.42.707-3.643a16.6 16.6 0 0 0-.117-3.618 16.8 16.8 0 0 0-2.399-6.565 18.3 18.3 0 0 0-4.376-4.825l.004-.003L38.622 6.093q-.022-.019-.046-.036c-1.162-.892-3.116-.889-4.394.005-1.292.904-1.44 2.399-.29 3.342l-.005.005 7.387 6.007-22.515.024h-.03c-1.861.002-3.65 1.223-4.004 2.766-.364 1.572.9 2.876 2.835 2.883l-.003.007 11.412-.022L8.605 36.705l-.078.058c-1.921 1.471-2.542 3.917-1.332 5.465 1.228 1.574 3.839 1.577 5.78.009l11.114-9.096s-.162 1.228-.149 1.965m28.559 4.112c-2.29 2.333-5.496 3.656-8.965 3.663-3.474.006-6.68-1.305-8.97-3.634a10.7 10.7 0 0 1-2.448-3.832 9.95 9.95 0 0 1-.562-4.282 10.1 10.1 0 0 1 1.227-4.031 11.1 11.1 0 0 1 2.724-3.239c2.226-1.814 5.06-2.796 8.024-2.8 2.967-.004 5.799.969 8.027 2.777a11.1 11.1 0 0 1 2.721 3.229 10.1 10.1 0 0 1 1.232 4.029 10 10 0 0 1-.564 4.279 10.7 10.7 0 0 1-2.446 3.841" style="fill:#f4792b;fill-rule:nonzero"/>
        </svg>
    }
}
